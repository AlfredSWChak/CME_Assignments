...
'''
Exercise 2a: Monte Carlo simulation, Approximated rejection region and Monte Carlo p-value
'''
print('Exercise 2a:')
...
# calculate the estimated coefficients by OLS estimator
...
# calculation for Durbin-Watson test statistic
...
for i in range(1, numberOfSimulations_b+1):
    ...
    # obtain a sequence of simulated test statistics
...
'''
Exercise 2b: Approximate confidence interval for ρ
'''
print('Exercise 2b:')
...
# obtain the coverage of confidence interval for true ρ
...
'''
Exercise 3b: Under the alterative ρ = 0.4
'''
print('Exercise 3b:')
...
# obtain the power of the Durbin-Waston test
